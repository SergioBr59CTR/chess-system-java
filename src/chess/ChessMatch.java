...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (!type.equals("B") && !type.equals("C") && !type.equals("T") & !type.equals("M")) {
	...
	private ChessPiece newPiece(String type, Color color) {
		...
		if (type.equals("M")) return new Queen(board, color);
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("A peca escolhida nao pode se mover a posicao de destino");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("Nao existe o rei da " + color + " na mesa");
	}
